...
public class CadastroEstoque extends javax.swing.JFrame {
    ...
    public String convertData(String data) {
        ...
        String mes = txtDataEntrada.getText().substring(3, 5);
        String ano = txtDataEntrada.getText().substring(6);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Cadastro Produtos.");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Descrição produto.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP));
        ...
        cbmStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Estoque", "Esgotado" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cbmStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        setSize(new java.awt.Dimension(414, 244));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       model.setQuant(Integer.parseInt(txtQuant.getText()));
       model.setData_cadastro(convertData(txtDataEntrada.getText()));
       HomePage p = new HomePage();
       model.setUser_cad(p.pega(nome));
       model.setStatus((String) cbmStatus.getSelectedItem());
       cadast.CadastrarN(model);
